...
function DateChange(props){
  ...
  return (
    <div id="food-tracking-main-change-date">
      ...
      <span id="food-tracking-main-date">{(new Date(props.date)).toDateString() === (new Date()).toDateString()  ? "Today, " : ""}{(new Date(props.date)).toLocaleDateString("en-US", options)}</span>
